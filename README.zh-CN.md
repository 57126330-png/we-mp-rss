...
- **如何按标签配置消息任务？**
  1. 先在“标签管理”里确保标签与公众号关联完备，一个公众号可以挂多个标签。
  2. 新建或编辑消息任务时，在“标签”区域选择需要同步的标签，可与“公众号”多选同时使用。
  3. 至少需要选择一个标签或公众号；系统会自动合并并去重最终的公众号列表。
  4. 保存后点击“应用”按钮重新加载任务，再执行一次“测试”或“执行”确认覆盖范围与日志。
